...
export default function InventoryHeader({ onSearch, onNewMaterial }: InventoryHeaderProps) {
  return (
    <header className="h-16 flex items-center justify-between px-8 bg-white border-b border-slate-200">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="bg-primary hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-all shadow-sm"
        >
          <Plus size={20} />
          New Material
        </button>
